...
A repo for the project rnn_dinos.
...
```
    ...
    │                         `2024-07-19-jqp-initial-data-exploration`
    │
...
- in the project directory `rnn_dinos` run `virtualenv --python=/usr/local/bin/python3 venv`
