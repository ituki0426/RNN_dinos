...
def adam(param, param_adam, grad, lr , beta1, beta2, epsilon, L2_reg, t) -> None:
    """
    Adam optimizer
    Arguments:
    ...
    m_hat = param_adam["mWax"] / (1 - beta1**t)
    v_hat = param_adam["vWax"] / (1 - beta2**t)
    ...
    m_hat = param_adam["mWaa"] / (1 - beta1**t)
    v_hat = param_adam["vWaa"] / (1 - beta2**t)
    ...
    m_hat = param_adam["mWya"] / (1 - beta1**t)
    v_hat = param_adam["vWya"] / (1 - beta2**t)
    ...
    m_hat = param_adam["mba"] / (1 - beta1**t)
    v_hat = param_adam["vba"] / (1 - beta2**t)
    ...
    m_hat = param_adam["mby"] / (1 - beta1**t)
    v_hat = param_adam["vby"] / (1 - beta2**t)
